...
urlpatterns = [
    ...
    url(r'^simjury/$', similar_jury_page, name="simjury"),
    url(r'^simjury/(?P<comp_id>\d+)$', similar_jury_page, name="simjury"),
    ...
    url(r'^metcomp/(?P<comp_id>\d+)$', metcomp_page, name="metcomp"),
    url(r'^method_comp/$', method_comparison, name="method_comp"),
    url(r'^devs/$', deviations_page, name="devpage"),
    url(r'^devs/(?P<comp_id>\d+)$', deviations_page, name="devpage"),
    ...
    url(r'^coherence/(?P<comp_id>\d+)$', coherence_page, name="coherpage"),
